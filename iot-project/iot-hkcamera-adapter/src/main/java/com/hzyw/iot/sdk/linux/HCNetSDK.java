...
package com.hzyw.iot.sdk.linux;
...
//import alarmjavademo.HCNetSDK.NET_DVR_PTZPOS;
//import alarmjavademo.HCNetSDK.FMSGCallBack;
//import alarmjavademo.HCNetSDK.FMSGCallBack_V31;
//import alarmjavademo.HCNetSDK.NET_DVR_AID_INFO;
//import alarmjavademo.HCNetSDK.NET_DVR_DIRECTION;
//import alarmjavademo.HCNetSDK.NET_DVR_PLATE_INFO;
//import alarmjavademo.HCNetSDK.NET_DVR_SCENE_INFO;
//import alarmjavademo.HCNetSDK.NET_DVR_SETUPALARM_PARAM;
//import alarmjavademo.HCNetSDK.NET_DVR_TIME_EX;
//import alarmjavademo.HCNetSDK.NET_DVR_TIME_V30;
//import alarmjavademo.HCNetSDK.NET_DVR_VEHICLE_INFO;
//import alarmjavademo.HCNetSDK.NET_ITS_PICTURE_INFO;
//import alarmjavademo.HCNetSDK.NET_VCA_DEV_INFO;
//import alarmjavademo.HCNetSDK.NET_VCA_RECT;
//import alarmjavademo.HCNetSDK.NET_VCA_POINT;
//import alarmjavademo.HCNetSDK.NET_VCA_RECT;
...
//	public  fLoginResultCallBack cbLoginResult;
	...
	public  FLoginResultCallBack cbLoginResult;
	Pointer pUser;
	public int bUseAsynLogin;//byzhu  WIN版本定义的是布尔型的
  	public  byte[] byRes2 = new byte[128];
}
...
/*
 * 很奇葩，以下是WIN64版本的 字段定义的类型有可能不一样 如sLicense
 * public static class NET_DVR_PLATE_INFO extends Structure
{
          public byte byPlateType;                    //车牌类型
          public byte byColor;                        //车牌颜色
...
/*public static class NET_DVR_TFS_ALARM  extends Structure {
	...
	public int dwAbsTime;               //绝对时标   事件发生时间 我们取值是这个
	...
	public byte[] byIllegalCode = new byte[ILLEGAL_LEN32];//违法代码扩展，当dwIllegalType值为0xffffffff；使用这个值
...
public byte byVehicleHeadTailStatus; //车头车尾状态 0-保留 1-车头 2-车尾   ====？？？add byzhu c文件的结构体里是有此字段的，这里加上了但未验证，不确定是否有影响=====
