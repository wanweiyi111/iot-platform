...
import com.hzyw.iot.commandManager.commandbuidler.CommandAssemblyImpl;
...
import com.hzyw.iot.commandManager.data.TaskDaoImpl;
import com.hzyw.iot.commandManager.handler.DefaultOutHandlerMethod;
import com.hzyw.iot.commandManager.handler.KeepAliveHandler;
import com.hzyw.iot.commandManager.handler.OutHandlerMethod;
import com.hzyw.iot.commandManager.handler.TaskHandler;
import com.hzyw.iot.commandManager.handler.TaskHandlerImpl;
...
public class CommandManagerImpl implements CommandManager {
	...
	@Override
	public CommandTasker start(String id, String command, boolean hasPath) {
		if (isInit(true)) {
