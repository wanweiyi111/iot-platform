...
public class NewEtcClient {
	private static final Logger LOGGER = LoggerFactory.getLogger(NewEtcClient.class);
            ...
            b.handler(new ChannelInitializer<SocketChannel>() {
                ...
                public void initChannel(SocketChannel ch) throws Exception {
                    ...
                    ch.pipeline().addLast(
                    		...
                    		new LengthFieldBasedFrameDecoder(1024, 3, 1, 3, 0),//https://blog.csdn.net/u014801432/article/details/81909902
                            new NewEtcClientIntHandler());
                }
            });
    ...
    public static void main(String[] args) throws Exception {
        NewEtcClient client = new NewEtcClient();
